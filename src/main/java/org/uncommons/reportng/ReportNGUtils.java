...
public class ReportNGUtils {
	...
	/**
	 * Decorate the string representation of an argument to give some hint as to its
	 * type (e.g. render Strings in double quotes).
	 * 
	 ...
	 * corresponding XML/HTML entities to avoid problems displaying the String in an
	 * XML document. Assumes that the String does not already contain any entities
	 ...
	 * @return An XML entity representing the character (or a String containing just
	 *         the character if it does not need to be escaped).
	 */
	 ...
	 * numeric ID, separated by an 'at' sign. We only want to use the thread name as
	 * the ID is mostly unimportant and it takes up too much space in the generated
	 * report.
	 * 
